...
# DVE full session
# Saved on Sat Dec 4 00:16:05 2021
# Designs open: 1
#   Sim: dve
...
#   Group id_rs signal count = 12
#   Group ROB INPUT FROM CDB&FU signal count = 12
#   Group ROB signal count = 33
...
#<Session mode="Full" path="/afs/umich.edu/user/g/u/guohch/Desktop/EECS470/Project/final_project/milestone_4/milestone3/session1.inter.vpd.tcl" type="Debug">
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 335} {height 1144} {dock_state left} {dock_on_new_line true} {child_hier_colhier 237} {child_hier_coltype 174} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 298} {height 1144} {dock_state left} {dock_on_new_line true} {child_data_colvariable 210} {child_data_colvalue 38} {child_data_coltype 101} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 2559} {height 156} {dock_state bottom} {dock_on_new_line true}}
...
gui_show_window -window ${TopLevel.2} -show_state maximized -rect {{1 260} {2560 1635}}
...
set _session_group_1 Memory
gui_sg_create "$_session_group_1"
set Memory "$_session_group_1"

gui_sg_addsignal -group "$_session_group_1" { testbench.memory.proc2mem_addr testbench.memory.proc2mem_data testbench.memory.proc2mem_command testbench.memory.mem2proc_response testbench.memory.mem2proc_data testbench.memory.mem2proc_tag }

set _session_group_2 ID_STAGE
gui_sg_create "$_session_group_2"
set ID_STAGE "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { testbench.pipeline_top_0.pipeline_front_0.id_stage_0.id_packet_out_2 testbench.pipeline_top_0.pipeline_front_0.id_stage_0.id_packet_out_1 testbench.pipeline_top_0.pipeline_front_0.id_stage_0.id_packet_out_0 testbench.pipeline_top_0.pipeline_front_0.inst_avail_num testbench.pipeline_top_0.pipeline_front_0.if_stage_0.rs_rob_haz_stall testbench.pipeline_top_0.pipeline_back_0.ROB_inst.rob_hazard_num testbench.pipeline_top_0.pipeline_front_0.if_stage_0.rs_avail_num }
...
gui_view_scroll -id ${Source.1} -vertical -set 4890
...
gui_wv_zoom_timerange -id ${Wave.1} 0 18405
...
gui_list_select -id ${Wave.1} {testbench.pipeline_top_0.pipeline_back_0.ROB_inst.rob_hazard_num }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group ID_STAGE  -item {testbench.pipeline_top_0.pipeline_front_0.if_stage_0.rs_avail_num[4:0]} -position below

gui_marker_move -id ${Wave.1} {C1} 15560
